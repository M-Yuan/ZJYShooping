...
insert into goods values(NULL, 'A计划', '《A计划》脱出成龙以往影片格局，背景虽然仍是清末民初，剧情却讲述香港水警打海盗的传奇，影片风格诙谐，堆砌不少搞笑桥段，然故事完整、兼具正剧元素，开辟了1980年代成龙电影的全新剧情模式。', 56, 1, '香港嘉禾出品', '06.jpg', '香港电影');
insert into goods values(NULL, '赌神', '掀起了香港赌片的一个热潮。影片中饰演高进的周润发将演技发挥地淋漓尽致，他使我们看到一个由神到人再次升为神的那种震撼,惊喜与痛快。', 55, 1, '永盛电影公司', '07.jpg', '香港电影');
insert into goods values(NULL, '英雄本色', '尽情地发挥了吴宇森的“暴力美学”、“兄弟情”、“双枪”等标签式电影语汇，揭示了在善恶之间摆荡的人性  。影片并非港台江湖黑帮的内幕暴露，亦非社会现实的反映，而是活脱脱英雄神话的再造，完全是创作者的主观愿望，感情的投射。', 42, 1, '寰亚综艺娱乐集团有限公司', '08.jpg', '香港电影');
insert into goods values(NULL, '快餐车', '打斗场面可谓精彩纷呈，其中成龙、洪金宝、元彪三人灵巧的身手、无间的配合让人印象深刻，搞笑的戏剧场面堪称经典（华商网评）[6]  。全片拍得爽朗热闹，符合成龙电影一贯的娱乐观众需求（凤凰网评）[1]  。三位动作演员的配合打得热闹纷呈，但是为了打出新意，特意奔赴西班牙取景拍摄，呈现出浓烈的异域风情。', 56, 1, '香港嘉禾出品', '09.jpg', '香港电影');
insert into goods values(NULL, '至尊无上Ⅱ之永霸天下', '以一群赌徒为中心人物，剧情亦以一场赌局为牵引；但描述的却是一段兄弟恩怨情仇，内容与《至尊无上》并无相连之处。全片色彩浓烈，人物鲜明突出，大量火爆动作场面快速俐落，有浓厚的浪漫效果。而故事内容也很简洁。每位演员也演得各有特色，是一部较好的影片。', 56, 1, '永盛电影公司', '10.jpg', '台湾电影');
insert into goods values(NULL, '无间道III', '一个普通而又精彩的正义战胜邪恶的故事，在这个背景上，编剧根据自己的想象，勾勒出一幅生动的风情画，表现出一个消逝的、令人伤感的英雄世界。影片中导演刘伟强娴熟、巧妙地运用了大量闪回境头，以人物思绪的变化作为事件的衔接点，时空交错表现得自然、流畅，不显丝毫斧凿痕迹，很多场面给人留下了难忘的印象，显示出刘伟强等导演过人的艺术功力。', 56, 1, '寰亚综艺娱乐集团有限公司', '11.jpg', '香港电影');
insert into goods values(NULL, '新警察故事', '没有延续成龙以往的动作喜剧片，而是一部动作剧情片，一改轻松风格、大谈感情，更多讲述的是兄弟情、以及成龙与杨采妮的爱情。', 39, 1, '英皇影业有限公司', '12.jpg', '香港电影');
insert into goods values(NULL, '全名目击', '采用多角度叙事结构，通过大众群体、律师余男、检察官郭富城、富豪孙红雷的四个视角去讲述同一件事情，不同的角度展现不同的细节与观点，制造层层悬念，最终还原出事情的真相。', 56, 1, '电广传媒影业(北京)有限公司', '13.jpg', '大陆电影');
insert into goods values(NULL, '风声', '有典型谍战片的先天优势，好剧本做底，再加上奢靡考究的布景，香艳典雅的人物造型，绚丽而怀旧的色调，漂亮炫目的摄影，能把握心理细节的好演员，以及干脆利落行云流水的剪辑——每个细节都做足了功夫', 56, 1, '华谊兄弟传媒集团', '14.jpg', '大陆电影');
insert into goods values(NULL, '变形金刚5:胜利的堕落', '电影为了能展现出更多的汽车人，剧情的划分变的极其不合理，在这部作品中情感都是想当然的，没有酝酿，没有演变，甚至没有合理的起承转合，所有的情感，不管是友谊羁绊也好，还是幡然醒悟，都只是如同走马观花般的一带而过，而为了能给这个系列继续续命，电影又还想要力图去扩展更大的世界观', 56, 1, '美国孩之宝(Hasbro)公司', '15.jpg', '欧美电影');
