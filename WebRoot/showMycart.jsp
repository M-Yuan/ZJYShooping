...
// 从session中取出购物车；使用getGoodsNumByGoodsId函数
  ...
  <head>
	...
	<script type="text/javascript">
		...
		function ClearAllGoods(){
			window.open("ShoopingClServlet?type=clearGoods", "_self");
		}
		-->
  ...
  <center>
	<table width="80%" border="1" align="center" class="showMycart01" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
      	<td height="142" colspan="2" align="center">
      	  <!-- 通过submit提交form表单 -->
      	  <form action="ShoopingClServlet?type=updateGoods" method="post">
          <table width="100%" border="1" cellpadding="0" cellspacing="0" class="showMycart01">
              ...
              <tr>
                ...
                <td width="9%" align="center"><input type="hidden" name="goodsId" value="<%=goodsBean.get_goodsId() %>" /><input name="goodsNum" type="text" size="7" id="goodsNum" value="<%=mycartBO.getGoodsNumByGoodsId(goodsBean.get_goodsId()+"") %>" /></td>
                <td width="9%" align="center"><a href="ShoopingClServlet?type=deleteGoods&goodsId=<%=goodsBean.get_goodsId() %>">删除</a></td>
                <td width="9%" align="center"><a href="ShowGoodsClServlet?type=showDetail&goodsID=<%=goodsBean.get_goodsId() %>">查看</a></td>
              </tr>
              <%
              }
              %>
              <tr>
                ...
                <td align="center"><input type="submit" name="ReviseTheNumber" value="修 改 数 量" /></td>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="6">&nbsp;</td>
